...
const characters = [
  ...
  { name: "God of Steam and Machinery", age: "4th Epoch", gender: "Male", pathway: "Paragon", sequence: "0", factions: ["Church of the God of Steam and Machinery", "Intis Republic", "Loen Kingdom"], firstChapter: "3", diff: "normal" },
  ...
  { name: "Lord of Storms", age: "3rd Epoch", gender: "Male", pathway: "Tyrant", sequence: "0", factions: ["Rose Redemption", "Church of Storms"], firstChapter: "3", diff: "normal" },
  ...
  { name: "Daxter Goudreau", age: "5th Epoch", gender: "Male", pathway: "Visionary", sequence: "9", factions: ["Psychology Alchemists", "Tingen Asylum", "Loen Kingdom"], firstChapter: "53", diff: "hard" },
  ...
  { name: "Frunziar Edward", age: "5th Epoch", gender: "Male", pathway: "Justiciar", sequence: "5", factions: ["Loen Kingdom", "Loen Military", "Groselle's Travels"], firstChapter: "697", diff: "hard" },
  ...
  { name: "Qonas Kilgor", age: "5th Epoch", gender: "Male", pathway: "Black Emperor", sequence: "4", factions: ["Loen Kingdom"], firstChapter: "1017", diff: "hard" },
...
function dailyWinRecordedKey() {
  const uid = auth?.currentUser?.uid || "guest";
  return `lotmdle_classic_dailywin_${todayKey()}_${uid}_${currentDifficulty}`; 
}

function updateStreak(won) {
  const streakKey = streakKeyDaily(); 
  let current = parseInt(localStorage.getItem(streakKey) || "0", 10);
  const winKey = dailyWinRecordedKey();
